...
var categoryStrategyLevels = function() {
	var level1 = [
			...
			},
			{
				...
				useCase: {name: "ProcureToPay11B", link: {x: -90, y: 10}},
			} ]
	return [ {
		p2pObject : level1,
...
var sourcingAndContractsP2PLevels = function() {
	...
	var level2 = [ {
		...
		levels : [],
		useCase: {name: "ProcureToPay22B", link: {x: 40, y: -85}},
		deploymentsCase: {name: "ProcureToPay22", link: {x: 95, y: -50}}
	} ]
...
var contractAdministrationP2PLevels = function() {
	var level1 = [
			...
			},
			{
				...
				useCase: {name: "ProcureToPay31B", link: {x: -90, y: 10}},
			} ]
...
var sourcingAndContractsLevels = function() {
	var level1 = [ {
		...
		levels : [],
		useCase: {name: "ProcureToPay41", link: {x: 10, y: -90}}
	} ]
...
var pOsAndRecievingLevels = function() {
	var level1 = [ {
		...
		wrapLength : 110,
		levels : [],
		useCase: {name: "ProcureToPay511U", link: {x: -115, y: -20}},
		deploymentsCase: {name: "ProcureToPay511", link: {x: -115, y: -20}}
	}, {
	...
	var level2 = [ {
		...
		levels : [],
		useCase: {name: "ProcureToPay52U", link: {x: 60, y: 0}},
		deploymentsCase: {name: "ProcureToPay52", link: {x: 60, y: 0}}
	} ]
...
var invoiceMatchingLevels = function() {
	var level1 = [ {
		...
		id : "imLevel1_1",
		levels : [],
		deploymentsCase: {name: "ProcureToPay61", link: {x: 105, y: -45}}
	} ]
...
var creditPricingQuoteLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "QuoteToCash21B", link: {x: -40, y: -85}},
	} ]
...
var contractAdministrationLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "QuoteToCash31B", link: {x: -90, y: 10}},
	} ]
...
var orderManagementLevels = function() {
	var level1 = [ {
		...
		useCase: [{name: "QuoteToCash42U", link: {x: 10, y: -20}}, {name: "QuoteToCash42B", link: {x: -50, y: -20}}],
		deploymentsCase: {name: "QuoteToCash42", link: {x: 10, y: -20}}
	} ]
...
var billingLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "QuoteToCash51U", link: {x: 30, y: -15}},
		deploymentsCase: {name: "QuoteToCash51", link: {x: 30, y: -15}}
	} ]
...
var cashApplicationLevels = function() {
	var level1 = [ {
		...
		deploymentsCase: {name: "QuoteToCash61", link: {x: 30, y: -20}}
	} ]
...
var collectionsAndDisputeManagementLevels = function() {
	var level1 = [ {
		...
		angle : -280,
		levels : [],
		useCase: {name: "QuoteToCash72U", link: {x: 70, y: -15}},
		deploymentsCase: {name: "QuoteToCash72", link: {x: 70, y: -15}}
	}, {
...
var financialPlanningLevels = function() {
	...
	var level2 = [ {
		...
		levels : [],
		useCase: {name: "PlanToForecast22U", link: {x: 10, y: -55}},
		deploymentsCase: {name: "PlanToForecast22", link: {x: 10, y: -55}}
	} ]
...
var performanceManagementLevels = function() {
	var level1 = [ {
		...
		wrapLength : 90,
		levels : [],
		//deploymentsCase: {name: "ItTransitionToOperationCI31", link: {x: 25, y: 25}}
	}, {
...
var managementReportingLevels = function() {
	var level1 = [ {
		...
		angle : -90,
		levels : [],
		deploymentsCase: {name: "PlanToForecast53", link: {x: 65, y: -20}}
	}, {
...
var businessAnalyticsLevels = function() {
	var level1 = [ {
		...
		levels : [],
		deploymentsCase: {name: "PlanToForecast62", link: {x: -60, y: -15}}
	}, {
		name : "Distribute reports",
...
var rollingForcastLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "PlanToForecast71B", link: {x: -35, y: 35}},
	} ]
...
var portfolioOptimizationLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "AssetAcquireToRetire21B", link: {x: -30, y: -60}},
	} ]
...
var designProcurementLeanConstructionLevels = function() {
	var level1 = [
			...
			},
			{
				...
				angle : -80,
				levels : [],
				useCase: {name: "AssetAcquireToRetire41B", link: {x: 100, y: -20}},
			},
			{
...
var consolidationLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "RecordToReport31", link: {x: -90, y: 20}}
	} ]
...
var accountingReconcilliationsLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "RecordToReport52B", link: {x: -35, y: 60}}
	} ]
...
var closingJourneyEntriesLevels = function() {
	var level1 = [ {
		...
		angle : -90,
		levels : [],
		useCase: {name: "RecordToReport62B", link: {x: 15, y: -10}}
	}, {
...
var payrollTABenifitsSetupLevels = function() {
	var level1 = [ {
		...
		deploymentsCase: {name: "HireToRetire31", link: {x: -105, y: 5}},
	} ]
...
var goalsObjectiveLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "HireToRetire41B", link: {x: -60, y: -50}},
	} ]
	...
	var level2 = [
			{
				...
				stepLength : 150,
				connectedTo : [ "goalsObjectiveLevel1_0",
						"learningAndDevelopmentLevel2_0",
						"engagementCommunicationsLevel1_0" ],
				levels : [],
			}, {
...
var engagementCommunicationsLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "HireToRetire71B", link: {x: -40, y: 50}},
	} ]
...
var iTPortfolioManagementLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "ITStrategyToArchitecture21B", link: {x: -65, y: -55}},
	} ]
	...
	var level1 = [
			{
				...
				angle : -290,
				connectedTo : [ "applicationPerformanceManagementLevel1_0",
						"technicalRequirementsDesignLevel1_0" ],
				stepLength : 80,
				levels : [],
			},
			{
				...
				stepLength : 90,
				wrapLength : 70,
				connectedTo : [ "technicalRequirementsDesignLevel1_0",
						"incidentManagementContinuousImprovementLevel1_0" ],
...
var capacityPlanningManagementLevels = function() {
	...
	var level2 = [ {
		...
		levels : [],
		//useCase: {name: "Amelia", link: {x: 10, y: -90}}
	}, {
...
var incidentManagementContinuousImprovementLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "ItTransitionToOperationCI2UAmelia", link: {x: 40, y: 30}},
		deploymentsCase: {name: "ItTransitionToOperationCI21", link: {x: -30, y: 25}}
	} ]
...
var applicationPerformanceManagementLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "ItTransitionToOperationCI31U", link: {x: 10, y: -50}},
		deploymentsCase: {name: "ItTransitionToOperationCI31", link: {x: 80, y: -10}}
	} ]
...
var releaseAndDeploymentLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "ItTransitionToOperationCI42B", link: {x: 40, y: -40}}
	} ]
...
var requirementGatheringLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "NewProductDevelopment21B", link: {x: 25, y: -45}},
	} ]
...
var designDevelopmentLevels = function() {
	var level1 = [ {
		...
		levels : [],
		useCase: {name: "NewProductDevelopment31", link: {x: -90, y: 10}}
	}, {
...
var productQualificationTestingLevels = function() {
	var level1 = [ {
		...
		deploymentsCase: {name: "NewProductDevelopment43", link: {x: 80, y: -10}}
	} ]
...
var innovationPortfolioMangementLevels = function() {
	var level1 = [ {
		...
		levels : [],
		useCase: {name: "InnovateToCommercialization21B", link: {x: -50, y: -50}},
	}, {
...
var commercializationLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "InnovateToCommercialization31B", link: {x: -90, y: 0}},
	}, {
		...
		levels : [],
		useCase: {name: "InnovateToCommercialization32B", link: {x: 25, y: -45}},
	}, {
		name : "Launch product",
		align : "right",
		angle : -80,
...
var demandSensingLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "PlanToDelivery11B", link: {x: -115, y: -10}}, 
	}, {
		...
		levels : [],
		useCase: {name: "PlanToDelivery12", link: {x: -50, y: -45}},
	}, {
		...
		useCase: {name: "PlanToDelivery13B", link: {x: -35, y: 50}}
	} ]
...
var supplyNetworkPlanningLevels = function() {
	...
	var level2 = [ {
		...
		useCase: [{name: "PlanToDelivery21", link: {x: 20, y: -70}}, {name: "PlanToDelivery21B", link: {x: -30, y: -60}}], 
	} ]
...
var productionSourcingExecutionLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "PlanToDelivery32", link: {x: 25, y: 30}},
	}, {
...
var inboundLogisticsWarehousingLevels = function() {
	var level1 = [ {
		...
		useCase: {name: "PlanToDelivery61B", link: {x: -120, y: -10}}, 
	}, {
...
var outboundLogisticsLevels = function() {
	var level1 = [ {
		...
		levels : [],
		useCase: {name: "PlanToDelivery72", link: {x: 20, y: -60}},
	}, {
...
var materialCharacterizationLevels = function() {
	var level1 = [ {
		...
		angle : -200,
		levels : [],
		deploymentsCase: {name: "ProductLineManagement21", link: {x: 20, y: 20}}
	}, {
...
var productProcessChangeManagementLevels = function() {
	var level1 = [ {
		...
		useCase: [{name: "ProductLineManagement31", link: {x: -55, y: -55}}, {name: "ProductLineManagement31B", link: {x: 20, y: -30}}]
	} ]
...
var productLifeCycleMangementLevels = function() {
	...
	var level2 = [ {
		...
		useCase: {name: "ProductLineManagement42", link: {x: 100, y: -45}}
	} ]
